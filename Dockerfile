...
RUN --mount=type=cache,id=s/abe34ec4-94f4-4a73-b1ad-88126d3fa3d7-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/abe34ec4-94f4-4a73-b1ad-88126d3fa3d7-/var/cache/apt,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/abe34ec4-94f4-4a73-b1ad-88126d3fa3d7-/var/lib/apt,target=/var/lib/apt,sharing=locked \
    apt-get update && \
